...
> **Archive.** Day-of master plan. Current product documentation is [README.md](README.md). Event file map: [docs/HACKATHON.md](docs/HACKATHON.md).
...
6. propose bounded `US / visa+mastercard / <= $5,000 / 17.4% of total`;
7. rehearsal PASS;
8. `WAITING_HUMAN`;
